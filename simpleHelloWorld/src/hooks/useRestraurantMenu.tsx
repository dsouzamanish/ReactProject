...
export const useRestraurantMenu = (resId: string) => {
    ...
    const fetchData = async () => {
        const response = fetch("https://corsproxy.io/?https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=19.113645&lng=72.8697339&restaurantId="+resId);
